...
{
    public abstract class LibrarySystemAdrienneWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static LibrarySystemAdrienneWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(LibrarySystemAdrienneWebMvcModule).Assembly.FullName);
        }
        ...
        protected void UsingDbContext(Action<LibrarySystemAdrienneDbContext> action)
        {
            using (var context = IocManager.Resolve<LibrarySystemAdrienneDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected T UsingDbContext<T>(Func<LibrarySystemAdrienneDbContext, T> func)
        {
            T result;
        ...
        protected async Task UsingDbContextAsync(Func<LibrarySystemAdrienneDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<LibrarySystemAdrienneDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<LibrarySystemAdrienneDbContext, Task<T>> func)
        {
            T result;
